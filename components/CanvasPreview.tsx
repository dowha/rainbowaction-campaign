...
<a
  ...
  onClick={handleClick}
  className="inline-flex items-center gap-1 text-xs text-gray-700 hover:text-blue-600 transition border-b border-dotted border-current"
>
  <svg
